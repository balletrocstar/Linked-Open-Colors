...
urlpatterns = patterns('',
    ...
    (r'^void', lambda request: HttpResponsePermanentRedirect("/resources/void.rdf")),
    ...
    (r'^color/rgb/(?P<color>\d{1,3},\d{1,3},\d{1,3})$', 'colors.views.color'),
    (r'^color/rgb/(?P<rgb>\d{1,3},\d{1,3},\d{1,3}).html$', 'colors.views.rgb_csv_html'),
    (r'^color/rgb/(?P<rgb>\d{1,3},\d{1,3},\d{1,3}).rdf$', 'colors.views.rgb_csv_rdf'),
